...
[illustration: six photos labeled A through F showing a teacher at a chalkboard, a group of students, a Chinese flag, an American flag, a group of adults, and a family group]
...
1 在学校 In the school (Audio: 03-1)
...
[illustration: photo of a woman in professional attire]
...
2 在教室 In the classroom (Audio: 03-2)

[illustration: photo of a classroom with teacher and students]
...
3 在学校 In the school (Audio: 03-3)
...
[illustration: photo of two children at a computer]
...
| Subject | Predicate （不）是 | Noun/Noun Phrase |
|---|---|---|
| 李月 | 是 | 老师。 |
| 我 | 是 | 美国人。 |
| 我 | 不是 | 老师。 |
...
| Subject | Predicate Verb | Noun/Noun Phrase | 吗? |
|---|---|---|---|
| 你 | 是 | 美国人 | 吗? |
| 你 | 是 | 中国人 | 吗? |
| 你 | 是 | 老师 | 吗? |
...
[illustration: photo of Michael Jordan playing basketball]

Tā jiào Qiáodān，　　　　tā shì　　　　rén.
他　叫　乔丹（Michael Jordan），他是___人。

[illustration: photo of Yao Ming in a Rockets jersey]
...
[illustration: photo of a young boy studying]
...
[illustration: photo of a man in a suit at a chalkboard]

Wǒ shì　　　　，wǒ bú shì xuésheng，wǒ shì　　　　rén.
我　是___，我不是　学生，　我是___人。

## 拼音 Pinyin

1 发音辨析：声母j、q、x和z、c、s
...
[illustration: three diagrams showing tongue position for j, q, and x]

听录音并跟读，注意声母发音的区别 (Audio: 03-4)
...
[illustration: three diagrams showing tongue position for z, c, and s]

听录音并跟读，注意声母发音的区别 (Audio: 03-5)
Listen to the recording and read after it. Pay attention to the differences between the initials.

xǐ zǎo　　dǎsǎo　　sān cì　　zìjǐ
zuótiān　　zǎoshang　　cāochǎng　　Hànzì

2 发音辨析：韵母i、u、ü　Differentiation: pronunciation of the finals i, u, ü
...
u和ü都是圆唇音，但是发音时ü的舌位在前，舌尖抵住下齿背，而u的舌位在后，舌尖不能和下齿背接触，舌头要尽力往后收才能发对。

Both u and ü are pronounced with rounded lips. When saying ü, the tongue is in a front position, with the tip pressing the inner surface of the lower teeth; when saying u, the tongue is in a back position, with the tip staying away from the inner surface of the lower teeth, and the tongue should be held backwards to pronounce the sound right.

[illustration: three diagrams showing tongue position for i, u, and ü]

3 "不"的变调　Tone Sandhi of "不（bù）" (Audio: 03-6)
...
4 拼音规则（2）：单韵母ü和ü开头的韵母跟j、q、x相拼的规则
...
|---|---|---|
| ㇆ 横折钩 héngzhégōu horizontal-turning-hook | [illustration: stroke direction diagram] | 门 mén door 月 yuè moon |
| ㇃ 卧钩 wògōu lying hook | [illustration: stroke direction diagram] | 心 xīn heart 您 nín (polite) you |
...
[illustration: character evolution of 月 from pictograph to modern form, with stroke order grid showing yuè]

（2）"心"，表示心脏。
"心" refers to the heart.

[illustration: character evolution of 心 from pictograph to modern form, with stroke order grid showing xīn]

（3）"中"，本义是飘扬的旗子，现在表示方位，意思是"中间"。
The basic meaning of "中" is "flying flag". It is now a word of locality, meaning "middle".

[illustration: character evolution of 中 from pictograph to modern form, with stroke order grid showing zhōng]

（4）"人"，表示直立的人。
"人" originally looked like a person standing straight.

[illustration: character evolution of 人 from pictograph to modern form, with stroke order grid showing rén]
...
|---|---|---|
| 先横后竖 Horizontal preceding vertical | 十 shí ten 工 gōng work, labor | 一十 一丁工 |
| 先撇后捺 Left-falling preceding right-falling | 八 bā eight 人 rén human | ノ八 ノ人 |
...
例如：A: 我　叫李　月，我是　中国　人，我是老师。
Wǒ jiào Dàwèi，　　　　wǒ shì Měiguó rén，wǒ shì xuésheng.
B: 我　叫　大卫（David），我是　美国　人，我是　学生。

2 小组活动　Group Work

3~4人一组，用汉语互相询问名字和国籍，每组请一位同学报告情况。
Work in groups of 3-4 and ask about each other's names and nationalities. Each group chooses one member to make a report.
