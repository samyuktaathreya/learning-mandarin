...
TORCH_API ::std::tuple<at::Tensor,at::Tensor> grid_sampler_2d_backward_mps(const at::Tensor & grad_output, const at::Tensor & input, const at::Tensor & grid, int64_t interpolation_mode, int64_t padding_mode, bool align_corners, ::std::array<bool,2> output_mask);
} // namespace native
} // namespace at
