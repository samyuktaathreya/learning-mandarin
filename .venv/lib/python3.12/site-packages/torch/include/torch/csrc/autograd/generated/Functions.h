...
#ifdef _WIN32
struct GridSampler2DBackwardBackward0 : public TraceableFunction {
  TORCH_API GridSampler2DBackwardBackward0() = default;
#else
struct TORCH_API GridSampler2DBackwardBackward0 : public TraceableFunction {
#endif
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "GridSampler2DBackwardBackward0"; }
  void release_variables() override {
    std::lock_guard<std::mutex> lock(mutex_);
    grad_output_.reset_data();
    grid_.reset_data();
...
#ifdef _WIN32
struct GridSampler3DBackwardBackward0 : public TraceableFunction {
  TORCH_API GridSampler3DBackwardBackward0() = default;
#else
struct TORCH_API GridSampler3DBackwardBackward0 : public TraceableFunction {
#endif
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "GridSampler3DBackwardBackward0"; }
  void release_variables() override {
    std::lock_guard<std::mutex> lock(mutex_);
    grad_output_.reset_data();
    grid_.reset_data();
...
#ifdef _WIN32
struct GridSampler2DCpuFallbackBackwardBackward0 : public TraceableFunction {
  TORCH_API GridSampler2DCpuFallbackBackwardBackward0() = default;
#else
struct TORCH_API GridSampler2DCpuFallbackBackwardBackward0 : public TraceableFunction {
#endif
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "GridSampler2DCpuFallbackBackwardBackward0"; }
  void release_variables() override {
    std::lock_guard<std::mutex> lock(mutex_);
    grad_output_.reset_data();
    grid_.reset_data();
...
#ifdef _WIN32
struct LdexpBackward0 : public TraceableFunction {
  TORCH_API LdexpBackward0() = default;
#else
struct TORCH_API LdexpBackward0 : public TraceableFunction {
#endif
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "LdexpBackward0"; }
  void release_variables() override {
    std::lock_guard<std::mutex> lock(mutex_);
    other_.reset_data();
    result_.reset_data();
...
#ifdef _WIN32
struct AminmaxBackward0 : public TraceableFunction {
  TORCH_API AminmaxBackward0() = default;
#else
struct TORCH_API AminmaxBackward0 : public TraceableFunction {
#endif
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "AminmaxBackward0"; }
  void release_variables() override {
    std::lock_guard<std::mutex> lock(mutex_);
    self_.reset_data();
    max_.reset_data();
...
#ifdef _WIN32
struct FusedRmsNormBackward0 : public TraceableFunction {
  TORCH_API FusedRmsNormBackward0() = default;
#else
struct TORCH_API FusedRmsNormBackward0 : public TraceableFunction {
#endif
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "FusedRmsNormBackward0"; }
  void release_variables() override {
    std::lock_guard<std::mutex> lock(mutex_);
    input_.reset_data();
    weight_.reset_data();
...
#ifdef _WIN32
struct UpsampleLanczos2DAaBackward0 : public TraceableFunction {
  TORCH_API UpsampleLanczos2DAaBackward0() = default;
#else
struct TORCH_API UpsampleLanczos2DAaBackward0 : public TraceableFunction {
#endif
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "UpsampleLanczos2DAaBackward0"; }
  void release_variables() override {
...
#ifdef _WIN32
struct UpsampleLanczos2DAaBackwardBackward0 : public TraceableFunction {
  TORCH_API UpsampleLanczos2DAaBackwardBackward0() = default;
#else
struct TORCH_API UpsampleLanczos2DAaBackwardBackward0 : public TraceableFunction {
#endif
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "UpsampleLanczos2DAaBackwardBackward0"; }
  void release_variables() override {
...
#ifdef _WIN32
struct CudnnGridSamplerBackwardBackward0 : public TraceableFunction {
  TORCH_API CudnnGridSamplerBackwardBackward0() = default;
#else
struct TORCH_API CudnnGridSamplerBackwardBackward0 : public TraceableFunction {
#endif
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "CudnnGridSamplerBackwardBackward0"; }
  void release_variables() override {
    std::lock_guard<std::mutex> lock(mutex_);
    grad_output_.reset_data();
    grid_.reset_data();
...
#ifdef _WIN32
struct MiopenCtcLossBackward0 : public TraceableFunction {
  TORCH_API MiopenCtcLossBackward0() = default;
#else
struct TORCH_API MiopenCtcLossBackward0 : public TraceableFunction {
#endif
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "MiopenCtcLossBackward0"; }
  void release_variables() override {
    std::lock_guard<std::mutex> lock(mutex_);
    result0_.reset_data();
    result1_.reset_data();
...
#ifdef _WIN32
struct MiopenCtcLossBackward1 : public TraceableFunction {
  TORCH_API MiopenCtcLossBackward1() = default;
#else
struct TORCH_API MiopenCtcLossBackward1 : public TraceableFunction {
#endif
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "MiopenCtcLossBackward1"; }
  void release_variables() override {
    std::lock_guard<std::mutex> lock(mutex_);
    result0_.reset_data();
    result1_.reset_data();
...
#ifdef _WIN32
struct CudnnAttentionBackward0 : public TraceableFunction {
  TORCH_API CudnnAttentionBackward0() = default;
#else
struct TORCH_API CudnnAttentionBackward0 : public TraceableFunction {
#endif
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "CudnnAttentionBackward0"; }
  void release_variables() override {
    std::lock_guard<std::mutex> lock(mutex_);
    attn_bias_.reset_data();
    cum_seq_k_.reset_data();
...
#ifdef _WIN32
struct NarrowCopyBackward0 : public TraceableFunction {
  TORCH_API NarrowCopyBackward0() = default;
#else
struct TORCH_API NarrowCopyBackward0 : public TraceableFunction {
#endif
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "NarrowCopyBackward0"; }
  void release_variables() override {
...
#ifdef _WIN32
struct ForeachCloneBackward0 : public TraceableFunction {
  TORCH_API ForeachCloneBackward0() = default;
#else
struct TORCH_API ForeachCloneBackward0 : public TraceableFunction {
#endif
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "ForeachCloneBackward0"; }
  void release_variables() override {
